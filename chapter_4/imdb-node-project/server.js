...
let url = "https://api.themoviedb.org/3/search/movie?api_key=5b805aa4447e5da63b6055814c21b31a&query="
...
app.get('/movie/:id', (req, res) => {
  ...
  res.render('pages/movie', { specificMovie });
...
// let search = "";
// for (i = 0; i < movies.length; i++) {
//   if (req.params.title === movies[i].title) {
...
app.get('/search/:input', (req, res) => {
  ...
  request(url + req.params.input, function (error, data) {
    ...
    res.render('pages/search', { searched });
...
app.get('/movieresults/:id', (req, res) => {


  request("https://api.themoviedb.org/3/movie/" + req.params.id + "?api_key=5b805aa4447e5da63b6055814c21b31a", function (error, data) {
   ...
   let searchResult = results;
    ...
    res.render('pages/movieresults', { searchResult });
...
//       // res.render('pages/search', { searchedMovie })
//     })
// });
